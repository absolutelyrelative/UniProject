...
public class credentialschangeViewListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if ((e.getActionCommand()).equals("Cambia Password")) {
            ...
            Utente utente = UtenteBusiness.getInstance().findByUsername(this.username.getText());
            if (utente != null) {
                result = UtenteBusiness.getInstance().changePassword(this.username.getText(), old_password, new_password);
                ...
                JOptionPane.showMessageDialog(null, "Non è stato possibile trovare l'utente associato all'utente dato.");
            }
